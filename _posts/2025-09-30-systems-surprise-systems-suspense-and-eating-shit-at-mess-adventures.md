...
*<strong>Systems Suspense</strong> A player's sense of systems suspense runs parallel to their content suspense over how plot, character arcs, etc., might resolve. Suspense (in either form) demands not just  their uncertainty, but also an active engagement with it.*
